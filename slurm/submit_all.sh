#!/bin/bash
# ============================================================
# Submit all benchmark jobs (B0-B10) — Stage 1 walk-forward.
...
#   2. B0-B10 array only starts after smoke test exits cleanly
#
# After this finishes:
...
echo ""
echo "=== Submitting B0-B10 benchmark array (depends on smoke test) ==="
# --array=0-10 → 11 tasks (B0 through B10)
